...
public class WorkRequestConstants {
	...
	public static String ALPHACHAR_OWNERID = "Contains Alphabet or Special Character";
	...
	public static String ALPHACHAR_CUSTOMERID = "Customer Id contains Alphabet OR Special Characters";
	public static String LENGTH_CUSTOMERID = "Length of Customer Id cannot be more be 4 digit";
	public static String DIGIT_SPECIAL_CHARACTER_WORKTYPE = "Work Type contains digits or special characters";
